...
exports.modLoaderServer = {
    ...
    addImport: (mod, gamePath) => {
        app.use(`/mods/${mod.name}`, express.static(path.join(gamePath, 'mods', mod.name, mod.main)));
        app.use(`/mods/${mod.name}/assets`, express.static(path.join(gamePath, 'mods', mod.name, 'assets')));
